...
<img-comparison-slider>
    {% include figure.liquid path="assets/img/2024-05-02-fft/stage3even.png" class="img-fluid rounded z-depth-1" class="img-fluid rounded z-depth-1" slot="first" %}
    {% include figure.liquid path="assets/img/2024-05-02-fft/stage3odd.png" class="img-fluid rounded z-depth-1" class="img-fluid rounded z-depth-1" slot="second" %}
</img-comparison-slider>
